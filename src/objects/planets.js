...
var saturn = buildARock(47,'planet', 0x838586,true,true,0,0,2044);
var uranus = buildARock(19.9,'planet', 0x838586,true,true,0,0,3012);
var neptune = buildARock(19,'planet', 0x838586,true,true,0,0,4096);
var pluto = buildARock(1.2,'planet', 0xffffff,true,true,0,0,5040);
