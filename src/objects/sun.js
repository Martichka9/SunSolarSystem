...
function addLight( h, s, l, x, y, z ) {
    ...
    var light = new THREE.PointLight( 0xff0000, 2, 0 );
    ...
    lensflare.addElement( new LensflareElement( textureFlare3, 1100, 0.7 ) );
    lensflare.addElement( new LensflareElement( textureFlare3, 600, 0.9 ) );
    lensflare.addElement( new LensflareElement( textureFlare3, 400, 1 ) );
    light.add( lensflare );
...
//sun
var sun = buildARock(5,'star','0xffae42',false,false,0,0,0);
